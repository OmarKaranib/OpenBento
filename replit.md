...
- **Production Space Optimization (Feb 2026):** Request dropdown added to header (idea/bug mailto links). Promo code BENTO2FREE displayed in pricing modal (2 Months Free Trial). Footer removed to maximize grid space. Legal links (Terms/Privacy) moved to sidebar bottom in small dimmed text. Final YouTube Shield: strict if (iframe.parentNode === container) check in safeCleanupPlayer prevents NotFoundError.
